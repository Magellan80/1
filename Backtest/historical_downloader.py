...
# ТОП‑20 монет, идеально подходящих под твою систему
SYMBOLS = [
    # ТОП‑10 (лучшие из лучших)
    "TONUSDT", "UNIUSDT", "BTCUSDT", "AXSUSDT", "DOGEUSDT",
    "APTUSDT", "NEARUSDT", "ADAUSDT", "RNDRUSDT", "FTMUSDT",

    # ТОП‑20 (расширенный список)
    "RUNEUSDT", "MATICUSDT", "LTCUSDT", "ETHUSDT", "RAYUSDT",
    "BNBUSDT", "1000PEPEUSDT", "ZECUSDT", "PIPPINUSDT", "TAOUSDT",
]

TIMEFRAMES = ["5m", "15m", "1h", "4h"]

# ✔ Правильные лимиты для 1 года
CANDLES_PER_TF = {
    "5m": 105000,
    "15m": 35000,
    "1h": 9000,
