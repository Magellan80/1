...
class V30BacktestEngine:
    ...
    def run(
        ...
        for i in range(250, total):
            ...
            # универсальный вызов RegimeEngine: поддержка старых и новых сигнатур
            regime = None
            try:
